...
--> statement-breakpoint
ALTER TABLE "video_frame_labels" ADD CONSTRAINT "video_frame_labels_video_frame_id_video_frames_id_fk" FOREIGN KEY ("video_frame_id") REFERENCES "public"."video_frames"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
